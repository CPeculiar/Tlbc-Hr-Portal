              ...
              <ul className="text-sm">
                <li>
                  ...
                  viewBox="0 0 16 16"
                    ...
                    <span>Attendance Report for 11/08/24</span>
                  </Link>
                </li>
                <li>
                  <Link
                  ...
                  viewBox="0 0 16 16"
                    ...
                    <span>TLBC'24 Pre Conference Report</span>
                  </Link>
                </li>
                <li>
                  <Link
                  ...
                  viewBox="0 0 16 16"
                    ...
                    <span>Financial Report for 3rd Synod</span>
                  </Link>
                </li>
                <li>
                  <Link
                ...
                <li>
                  ...
                  viewBox="0 0 16 16"
                    ...
                    <span>Media Report for 3rd Synod 2024</span>
                  </Link>
                </li>
                <li>
                  <Link
                  ...
                  viewBox="0 0 16 16"
                    ...
                    <span>TLBCM'24 Camp Meeting Report</span>
                  </Link>
                </li>
              </ul>
            </div>
                ...
                <li>
                  ...
                  viewBox="0 0 16 16"
                    ...
                    <span>
                      ...
                      <span className="text-gray-600 dark:text-gray-400">Conversation / … / TLBC'24</span>
                    </span>
                  </Link>
                </li>
                <li>
                  ...
                  viewBox="0 0 16 16"
                    ...
                    <span>
                      <span className="font-medium">Messages</span> -{' '}
                      <span className="text-gray-600 dark:text-gray-400">Conversation / … / CEO's Office</span>
                    </span>
                  </Link>
                </li>
              </ul>
