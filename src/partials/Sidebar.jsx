      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          <NavLink end to="/" className="block">
            ...
            <img src={Logo} alt="Logo" width={48} height={40} />
          </NavLink>
        </div>
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            ...
                            <span className="text-sm text-gray-500/90 font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                              Attendance
                            </span>
                          </div>
                          {/* Icon */}
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-8 mt-1 ${!open && "hidden"}`}>
                          ...
                          <li className="mb-1 last:mb-0">
                            ...
                            >
                              <span className="text-sm text-gray-500 font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                {/* Search - Churches */}
                              </span>
                            </NavLink>
                          </li>
                        ...
                        <ul className={`pl-8 mt-1 ${!open && "hidden"}`}>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              to="/login"
                              className="hover:text-gray-700 dark:hover:text-gray-200 transition duration-150 truncate"
                            >
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                Reset Password
                              </span>
                ...
                >
                  <div className="flex items-center">
                    ...
                    >
                      ...
                      <path d="M20.5 22v-2c0-2.485-1.795-4.5-4-4.5H7.5c-2.205 0-4 2.015-4 4.5v2"></path>
                      <path d="M22 12h-2m-4-4h-2"></path>
                    </svg>
