    ...
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
      <div className="px-5 pt-5">
        <header className="flex justify-between items-start mb-2">
          <h2 className="text-3xl font-bold text-gray-800 dark:text-gray-100 mb-2">Total Users</h2>
          {/* Menu button */}
          <EditMenu align="right" className="relative inline-flex">
            <li>
              <Link className="font-medium text-sm text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-gray-200 flex py-1 px-3" 
              to="/userspage">
                View Users
              </Link>
            </li>
        ...
        <div className="flex items-start">
          <div className="text-5xl font-bold text-gray-800 dark:text-gray-100 mr-2 ml-3">20</div>
